        ...
        <div class="col l4 s12">
            <div class="row admin-pro-div" >
                <div class="col s12 pro-ad teal lighten-5">
                    <div class="row">
                        <div class="col s12 cart-title">Rye Bread</div>
                        <div class="col s12 ad-pro-img" style="background-image:url(Resources/product1.jpg);"></div>
                        <div class="col s12">
                            <div class="row">
                                <div class="col s4 ad-pro-h1">Product ID :</div>
                                <div class="col s8 ad-pro-h2">B001</div>
                            </div>
                        </div>
                        <div class="col s12">
                            <div class="row">
                                <div class="col s4 ad-pro-h1">Product Name :</div>
                                <div class="col s8 ad-pro-h2">Rye Bread</div>
                            </div>
                        </div>
                        <div class="col s12">
                            <div class="row">
                                <div class="col s4 ad-pro-h1">Product Description :</div>
                                <div class="col s8 ad-pro-h2">Rye bread is a dense, flavorful bread made from rye flour.
                                    It
                                    has a dark color, robust taste, and chewy texture. Often featuring a tangy flavor
                                    from a
                                    sourdough starter, it may include caraway seeds for extra flavor. Popular in
                                    European
                        ...
                        <div class="col s12">
                            <div class="row">
                                ...
                                <div class="col s8 ad-pro-h2">Rs. 1000.00</div>
                            </div>
                        </div>
                    </div>
                </div>
