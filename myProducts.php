...
<body>
    ...
    <div class="row">
        <div class="col s12 cart-title">My Products</div>
    </div>
    <div class="row">
        ...
        <div class="col s12 teal lighten-5" style="margin-top: 10px;">
            <div class="row">
                ...
                <div class="col l1 s12 teal lighten-5 center-align mypro-content"><img src="Resources/product6.jpg" class="mypro-img" /></div>
                ...
                <div class="col l3 s12 teal lighten-5 center-align mypro-content">
                    <div class="row" style="display: flex; align-items: center; justify-content: center; flex-direction: column;">
                        ...
                        <div class="mypro-status">Sent to packing</div>
        ...
        <div class="col s12 teal lighten-5" style="margin-top: 10px;">
            <div class="row">
                ...
                <div class="col l1 s12 teal lighten-5 center-align mypro-content"><img src="Resources/product1.jpg" class="mypro-img" /></div>
                ...
                <div class="col l3 s12 teal lighten-5 center-align mypro-content">
                    ...
                    <a class="waves-effect waves-light btn-small teal lighten-2" style="margin-left: 10px; margin-right: 10px; width: 200px;">Add Feedback </a>
        ...
        <div class="col s12 teal lighten-5" style="margin-top: 10px;">
            <div class="row">
                <div class="col l1 s12 teal lighten-5 center-align mypro-content">102459</div>
                <div class="col l1 s12 teal lighten-5 center-align mypro-content"><img src="Resources/product5.jpg" class="mypro-img" /></div>
                <div class="col l3 s12 teal lighten-5 center-align mypro-content">Fruit Cake</div>
                <div class="col l2 s12 teal lighten-5 center-align mypro-content">2024-06-22</div>
                <div class="col l1 s12 teal lighten-5 center-align mypro-content">2</div>
                <div class="col l3 s12 teal lighten-5 center-align mypro-content teal-text deliverd-word">Delivered </div>
                <div class="col l1  s12 teal lighten-5 center-align mypro-content"><i class="material-icons small teal-text">delete</i></div>
            </div>
        </div>
    </div>
